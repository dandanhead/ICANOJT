...
<jsp:include page="../layout/header.jsp"/> <!--header  -->
	...
	<div class="layer" style="margin-left: 30%;">
		<div class="addform" style="float: left;">
			<div>
				<label>ID</label>
				<input type="text" class="form-control" style="width: 40%;" placeholder="Input your Id">
			</div>
			<div>
				<label>PW</label>
				<input type="password" class="form-control" style="width: 40%;" placeholder="Input your PW">
			</div>
			<div>
			...
			<div>
				...
				<div>
					<label class="radio-inline"> 
						<input type="radio"	name="sexradio" id="radiomale" value="male" checked="checked" >
							M
					</label>
					<label class="radio-inline"> 
			...
			<div>
				...
				<div class="row">
				  <div class="col-xs-3">
				    <input type="text" class="form-control" placeholder="앞 자리" value="877777" >
				  </div>
				  <div class="col-xs-3">
				    <input type="text" class="form-control" placeholder="뒷 자리" value="1111111">
				  </div>
				</div>
			</div>
			<div>
				...
				<div class="row">
				  ...
				  <div class="col-xs-3">
				    <input type="text" class="form-control" value="1010" >
				  </div>
				</div>
			</div>
			<div>
				<label>E-mail</label>
				<input type="email" class="form-control"  value="aaaa@naver.com">
			</div>
			<div>
			...
			<div>
				<label>License</label>
				<textarea rows="2" style="resize: none; width: 100%"  class="form-control" placeholder="Input your Licence"></textarea>
			</div>
			<div>
				<label>Language</label>
				<textarea rows="2" style="resize: none; width: 100%"  class="form-control" placeholder="input available Language & Environment"></textarea>
			</div>
			<div>
			...
			<div >
				<a class="btn btn-default" href="myPage.jsp" style="width: 40%;">Sumbit</a>
			</div>
		</div>
	</div>
</body>
